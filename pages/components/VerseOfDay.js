  ...
  return (
    <div className="max-w-7xl mx-auto z-50 px-4 sm:px-6">
      <div className=" bg-white shadow-lg rounded-xl  mt-10 p-8 text-gray-400	">
          <h2 className="text-yellow-600 font-bold mb-4">Verse of the day - BG 1.1</h2>
       <p> Dhṛtarāṣṭra said: O Sañjaya, after my sons and the sons of Pāṇḍu
        ...
        <button className="uppercase text-black mt-4">See more</button>
      </div>
    </div>
  );
};
